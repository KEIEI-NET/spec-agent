...
| セクター | 主要機能 | 準拠法規・標準 | 対応メーカー |
|---------|---------|--------------|------------|
| 🔧 **部品商社** | 部品カタログ管理、在庫予測、コンプライアンス検証 | PL法、IATF 16949、JAPIA-EDI | 全メーカー対応* |
| 🚚 **大型車両** | フリート管理、予防保全、24時間対応 | 道路運送車両法、排ガス規制 | 国産・輸入商用車 |
| 🏁 **欧州車** | VIN連動部品特定、診断システム連携 | ECE規格、型式認証 | 独・英・仏・伊車 |
| 🪟 **ガラス専門** | ADAS校正、ガラス仕様管理、保険連携 | JIS R 3211/3212、ECE R43 | 全メーカー対応 |
| ♻️ **リサイクル** | 解体工程管理、循環経済支援、マニフェスト管理 | 自動車リサイクル法、フロン法 | 全メーカー対応 |
...
**欧州車**
- ドイツ：BMW、メルセデスベンツ、アウディ、フォルクスワーゲン、ポルシェ
- その他：ボルボ、フィアット、プジョー/シトロエン、ルノー

**輸入商用車**
- スカニア、ボルボトラック、MAN、DAF、メルセデストラック
...
graph TB
    ...
    subgraph "Parts Commerce Sector"
        ...
        PC4[commercial-vehicle-parts-agent<br/>大型車両部品]
        PC5[european-vehicle-parts-agent<br/>欧州車部品]
    end
...
#### 🔧 部品商社セクター
| エージェント | 主要機能 | 生成仕様書 | 対応メーカー |
|-------------|---------|-----------|------------|
| **parts-catalog-agent** | 部品マスター管理、互換性DB、価格設定 | 部品カタログシステム仕様書 | 全メーカー対応 |
| **inventory-forecast-agent** | AI需要予測、在庫最適化、補充計画 | 在庫予測システム仕様書 | 全メーカー対応 |
| **compliance-verification-agent** | PL法準拠、IATF認証、品質保証 | コンプライアンス管理仕様書 | 全メーカー対応 |
| **commercial-vehicle-parts-agent** | フリート管理、24時間対応、予防保全 | 大型車両部品管理仕様書 | いすゞ、日野、三菱ふそう、UD、スカニア、ボルボ等 |
| **european-vehicle-parts-agent** | VIN連動、診断連携、純正/OEM管理 | 欧州車部品管理仕様書 | BMW、ベンツ、アウディ、VW、ポルシェ等 |
