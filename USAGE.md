...
Spec Agent System の詳細な使用方法を説明します。このガイドでは、各エージェントの具体的な使い方、実践的な使用例、ワークフローの構築方法を解説します。

## 📚 目次

1. [基本的な使い方](#基本的な使い方)
2. [エージェント別詳細ガイド](#エージェント別詳細ガイド)
3. [実践的な使用例](#実践的な使用例)
4. [ワークフロー構築](#ワークフロー構築)
5. [高度な使い方](#高度な使い方)
...
```
You: @spec-master-agent 新しいタスク管理アプリを作りたいです

Master: タスク管理アプリプロジェクトを開始します。
まず、基本情報を確認させてください：

1. アプリの形態（Web/モバイル/デスクトップ）
2. 想定ユーザー（個人/チーム/企業）
3. 必須機能（タスク作成、期限設定、通知など）
4. 開発期間と予算規模

これらの情報を基に最適な仕様書を作成します。
```
